    ...
    <header class="blog-header py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <div class="col-4 text-center">
                <a class="blog-header-logo text-dark" href="#">{{ucfirst($title)}}</a>
            </div>
                    ...
                    <div class="top-right links">
                        @auth
                           {{-- <a class="btn btn-sm btn-outline-secondary" href=" {{ route('logout') }}">Logout</a>--}}
                            <a class="btn btn-sm btn-outline-secondary" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
                                Logout
                            </a>
